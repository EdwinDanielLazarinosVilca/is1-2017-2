...
public class AlumnoService {
  ...
  public Alumno getByAlumno(String ApellidoPateterno) {
	    return repository.findAlumnoName(ApellidoPateterno);
	  }

  public Alumno save(Alumno alumnoChanged) {
    System.out.println("Modificando: " + alumnoChanged.getId());
    Alumno alumno = repository.findOne(alumnoChanged.getNombres());
    if (alumno != null) {
